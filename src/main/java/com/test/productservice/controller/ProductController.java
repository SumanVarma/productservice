...
public class ProductController {
    ...
    public Product createTodo(@Valid @RequestBody Product product) {
        product.setActive(true);
        return productRepository.save(product);
    }

    @GetMapping(value = "/products/{id}")
    public ResponseEntity<Product> getTodoById(@PathVariable("id") long id) throws ResourceNotFoundException {
    ...
    public ResponseEntity<Product> updateTodo(@PathVariable("id") Long id,
    ...
    public ResponseEntity<?> deleteTodo(@PathVariable("id") Long id) throws ResourceNotFoundException {
